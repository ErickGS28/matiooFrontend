                        ...
                        <div className="flex flex-1 items-center justify-center">
                            <div className="flex flex-col p-20 w-full max-w-full min-h-screen">
                                <div className="flex items-center">
                                    <h1 className="text-darkpurple-title text-[2.5em] font-semibold">Áreas comunes</h1>
                                    <img src="/commonArea.png" alt="commonArea" className="ml-auto w-[5em]" />
                                </div>
                                ...
                                <div className="my-3 mt-5 w-full flex items-center">
                                    ...
                                    <button
                                        type="submit"
                                        className="ml-[37em] bg-green-confirm text-white font-semibold py-2 px-4 rounded-full w-[160px] shadow shadow-purple-200  cursor-pointer"
                                    >
                                        Registrar
                                    </button>
                                </div>
