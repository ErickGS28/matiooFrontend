          ...
          <div className="flex flex-col p-5 md:px-20 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mt-[3em]">
              {filteredItems.map((item) => (
                <div
                  key={item.id}
                  className="bg-card-bg rounded-lg shadow-md hover:scale-105 transition-transform duration-300 ease-in-out w-[auto] hover:shadow-lg hover:shadow-purple-500"
                >
