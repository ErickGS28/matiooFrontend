...
export default function BtnRegistrar({ onAgregar }) {
  const handleClick = () => {
    if (onAgregar) onAgregar(); // Ejecuta toast en Responsible
  };
      ...
      <PopoverContent className="p-4 w-[20em] mr-[12em] bg-white border-1 border-black">
        <div className="w-[90%] m-auto">
          <div className="mb-[1em] flex items-center justify-center border-b border-purple-100">
            <img src="/responsiblePopover.png" alt="Responsable" className="w-[4em]" />
          </div>
          ...
          <div className="mt-[0.5em]">
            <Label htmlFor="bien" className="text-darkpurple-title mb-[0.5em]">Seleccionar bien</Label>
            <Select>
