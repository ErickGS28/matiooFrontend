    ...
    return (
        <>
            <div className="flex min-h-screen w-full">
                <AsideBar activePage="listItem" />
                <div className="flex flex-1 items-center justify-center">
                    <div className="flex flex-col p-20 w-full max-w-full min-h-screen">
                        <div className="flex items-center">
                            <h1 className="text-darkpurple-title text-[2.5em] font-semibold">Lista de bienes</h1>
                            <img src="/listItem.png" alt="becario" className="ml-auto w-[5em]" />
                        </div>
