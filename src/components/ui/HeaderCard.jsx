...
import BtnRegisterCommunArea from "@/components/ui/BtnRegisterCommunArea";

export default function Header({ title, image, filterInput}) {
        ...
        <div className="flex items-center">
          ...
          <div className="my-3 mt-5 w-full flex items-center flex-wrap gap-4">
            ...
            <div className="flex justify-end flex-grow">
              <BtnRegisterCommunArea infoBtn="Registrar área" />
            </div>
          </div></>
    );
}