                ...
                <div className="flex flex-1 items-center justify-center">
                    <div className="flex flex-col p-20 w-full max-w-full min-h-screen">
                        <div className="flex items-center">
                            <h1 className="text-darkpurple-title text-[2.5em] font-semibold">Modelo</h1>
                            <img src="/model.png" alt="itemType" className="ml-auto w-[5em]" />
                        </div>
                        ...
                        <div className="my-3 mt-5 w-full flex items-center flex-wrap gap-4">
                            <div className="flex items-center">
                                <input
                                    ...
                                    placeholder="Buscar bienes a mi nombre..."
                                />
