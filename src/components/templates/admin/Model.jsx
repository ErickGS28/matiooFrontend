                                    ...
                                    <PopoverContent className="p-4 w-[20em] mr-[12em] bg-white border-1 border-black">
                                        <div className="w-[90%] m-auto">
                                            <div className="mt-[2em] flex items-center justify-center border-b border-purple-100">
                                                <img src="../asidebarIMG/notaChida.png" alt="Cerrar sesión" className="w-[4em] mb-[2em]" />
                                            </div>



                                            <div className="mt-[0.5em] grid w-full max-w-sm items-center gap-1.5">
                                                <Label htmlFor="model" className="text-darkpurple-title">Seleccionar modelo</Label>
                                                <Input type="text" id="model" placeholder="" className="border-black" />
                                            </div>

                                            <div className="mt-[1.5em] mb-[2em] flex justify-center">
                                                <Button type="submit" className="bg-green-confirm">Agregar Modelo</Button>
                                            </div>
