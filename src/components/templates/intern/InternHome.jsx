          ...
          <div className="flex justify-between items-center mx-auto px-5">
            ...
            <div className="flex space-x-6">
              ...
              <Popover>
                              <PopoverTrigger asChild>
                                <div
                                  className={`flex items-center gap-4 h-10 px-4 rounded-2xl cursor-pointer bg-red-bg-icon transition-all duration-300 ease-in-out hover:scale-105 rounded-bl-[1.4em] rounded-br-[1.4em] rounded-tl-[0.5em] rounded-tr-[0.5em] ${
                                    isExpanded
                                      ? "justify-start gap-4 h-10 px-4 rounded-2xl"
