  ...
  return (
    <div className="flex items-center ml-4">
      <select
        ...
        className="cursor-pointer px-3 py-1 rounded-md shadow-lg shadow-purple-200  border-purple-200 focus:outline-none focus:ring-2 focus:ring-purple-800 bg-purple-50"
      >
